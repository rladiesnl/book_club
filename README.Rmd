...
## Use own email before knitting
# sheets_auth(email = "palolili@gmail.com")
...
```{r, echo=FALSE}
data %>% 
filter(!is.na(hosted_by)) %>% 
  mytable() %>% 
  row_spec(0, bold = T, color = " white", background = "#562457")
```

If you want to sign-up to present a topic in one of our events, [**click here**](https://bit.ly/2QBYGEG)

If you want to join the event, click at the link on our **_Current agenda_**!
